...
static void init_vmcb(struct kvm_vcpu *vcpu)
{
	...
	printk("[CHUQI] init_vmcb. INTERCEPT_INVLPG=%d\n",
			 svm_is_intercept(svm, INTERCEPT_INVLPG));
	printk("[CHUQI] init_vmcb. INTERCEPT_RDTSCP=%d\n",
			 svm_is_intercept(svm, INTERCEPT_RDTSCP));
	printk("[CHUQI] init_vmcb. INTERCEPT_CR0 read=%d write=%d\n",
			 svm_is_intercept(svm, INTERCEPT_CR0_READ),  svm_is_intercept(svm, INTERCEPT_CR0_WRITE));
	printk("[CHUQI] init_vmcb. INTERCEPT_INTERCEPT_SELECTIVE_CR0=%d mask=0x%lx\n",
			 svm_is_intercept(svm, INTERCEPT_SELECTIVE_CR0), SVM_CR0_SELECTIVE_MASK);
	printk("[CHUQI] init_vmcb. INTERCEPT_PUSHF=%d\n",
			 svm_is_intercept(svm, INTERCEPT_PUSHF));
	printk("[CHUQI] init_vmcb. INTERCEPT_POPF=%d\n",
			 svm_is_intercept(svm, INTERCEPT_POPF));
